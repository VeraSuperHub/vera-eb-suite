...
## Next Steps
- [ ] Read and execute reference/sub-skills/figure-creating.md to generate simulation plots
- [ ] Read and execute reference/sub-skills/manuscript-writing.md to draft LaTeX
- [ ] Read and execute reference/sub-skills/paper-compiling.md to build PDF
```
